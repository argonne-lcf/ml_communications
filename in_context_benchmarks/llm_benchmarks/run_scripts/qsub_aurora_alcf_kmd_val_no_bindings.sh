...
export CCL_WORKER_AFFINITY=1,9,17,25,53,61,69,77
export CPU_AFFINITY="list:2-8:10-16:18-24:26-32:54-60:62-68:70-76:78-84"
...
## For TP=12, PPN=12, No bindings, using the defaults
#export CCL_WORKER_AFFINITY=1,9,17,25,33,41,53,61,69,77,85,93
#export CPU_BIND="list:2-8:10-16:18-24:26-32:34-40:42-48:54-60:62-68:70-76:78-84:86-92:94-100"
#export HOROVOD_THREAD_AFFINITY="4,12,20,28,36,44,56,64,72,80,88,96"
#export MEM_BIND="list:2:2:2:2:2:2:3:3:3:3:3:3"
...
## RUN ID for JUST TP R12 setup, Regular, NIC imbalanced case, NO BINDINGS
RUN_ID=aurora_tensor_parallel_WITH_BINDINGS_SEQ${SEQ}_HID${HID}_TP${TP_DEGREE}_NO_SP_NO_USP_L${N_LAYERS}_TL${TIMING_LOOPS}_${PRECISION}_${IN_TYPE}_ELEM_${BUCKET}_N${NNODES}_R${NRANKS_PER_NODE}_T${TRIAL}_$(date +"%Y-%m-%d_%H-%M-%S")
...
-bucket ${BUCKET} --logging --log_directory=${BENCH_DIR}/run_scripts/outdir_aurora/logs/alcf_kmd_val_1099p12_2025p0p5/${RUN_ID} --log_file=${RUN_ID}.log
