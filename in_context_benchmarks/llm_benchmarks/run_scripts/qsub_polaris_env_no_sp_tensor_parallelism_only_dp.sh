...
python ${WORK_DIR}/tensor_parallel_with_gradient_synchronization_only_dp.py -n_layers ${N_LAYERS} \
-tp_degree=${TP_DEGREE} --barrier --dp_only --iterations=${TIMING_LOOPS} --precision ${PRECISION} \
