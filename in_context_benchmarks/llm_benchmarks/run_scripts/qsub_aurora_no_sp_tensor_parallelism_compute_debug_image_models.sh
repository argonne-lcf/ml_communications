...
## SEQ=4096, HID=16384, N_LAYERS=126, Llama 405B
## SEQ=4096, HID=25872, N_LAYERS=128, Llama 1T
TP_DEGREE=12
SEQ=4096
HID=25872
#WARMUPS=1
...
RUN_ID=aurora_tensor_parallel_SEQ${SEQ}_HID${HID}_TP${TP_DEGREE}_NO_SP_LAYERS${N_LAYERS}_TIMING_LOOPS${TIMING_LOOPS}_${PRECISION}_N${NNODES}_R${NRANKS_PER_NODE}_T${TRIAL}_$(date +"%Y-%m-%d_%H-%M-%S")
...
--logging --log_directory=${WORK_DIR}/run_scripts/outdir_aurora/logs/model_sweep_for_sc25 --log_file=${RUN_ID}.log
