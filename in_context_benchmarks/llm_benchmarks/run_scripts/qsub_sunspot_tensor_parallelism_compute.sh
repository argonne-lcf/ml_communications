...
RUN_ID=sunspot_tensor_parallel_TP${TP_DEGREE}_NO_SP_TIMING_LOOPS${TIMING_LOOPS}_N${NNODES}_R${NRANKS_PER_NODE}_T${TRIAL}
...
-tp_degree=${TP_DEGREE} --iterations=${TIMING_LOOPS} --logging --log_directory=${WORK_DIR}/run_scripts/outdir/logs --log_file=${RUN_ID}.log
