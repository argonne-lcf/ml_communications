...
# Trying SEQ=12936 (25872 / 2) for 1T+, 16896 leads to not divisible error
#
TP_DEGREE=12
SEQ=12936
HID=25872
...
RUN_ID=aurora_profile_tensor_parallel_SEQ${SEQ}_HID${HID}_TP${TP_DEGREE}_USP_L${N_LAYERS}_TL${TIMING_LOOPS}_${PRECISION}_${IN_TYPE}_ELEM_${BUCKET}_N${NNODES}_R${NRANKS_PER_NODE}_T${TRIAL}_$(date +"%Y-%m-%d_%H-%M-%S")
...
--logging --log_directory=${WORK_DIR}/run_scripts/outdir_aurora/logs/usp_scratch --log_file=${RUN_ID}.log --trace ${RUN_ID}
