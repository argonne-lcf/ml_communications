...
#PBS -k doe
#PBS -e /home/hossainm/ml_communications/in_context_benchmarks/2D_parallelism/run_scripts/errordir
#PBS -o /home/hossainm/ml_communications/in_context_benchmarks/2D_parallelism/run_scripts/outdir
#PBS -j oe
#PBS -N FP32_USP 
...
WORK_DIR=/home/hossainm/ml_communications/in_context_benchmarks/2D_parallelism
...
RUN_ID=polaris_tp_ulysses_zero3_ENV_PHB_Socket_${SOCKET}_USP${TP_DEGREE}_NOWARMUPS_NCCL_ALGO${ALGO}_LAYERS${N_LAYERS}_TIMING_LOOPS${TIMING_LOOPS}_${PRECISION}_N${NNODES}_R${NRANKS_PER_NODE}_T${TRIAL}_$(date +"%Y-%m-%d_%H-%M-%S")
...
python ${WORK_DIR}/tp_ulysses_zero3.py -n_layers ${N_LAYERS} \
--ulysses-degree=${USP_DEGREE} --use-zero3 --include-flash-attention --iterations=${TIMING_LOOPS} --precision ${PRECISION} \
